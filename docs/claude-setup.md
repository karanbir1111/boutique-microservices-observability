...
- Interact with AWS services (ECR, EKS, pricing)
...
- Search AWS-IA Terraform modules (OpenSearch, SageMaker)
...
**Key capabilities:**
- Look up pricing for any AWS service (EC2, EKS, Lambda, RDS, etc.)
